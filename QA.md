...
| `npm test` | **39 passed**, 7 test files |
| `npm run build` | Passed; 24 generated Next.js pages, 160 precached resources |
| `npm run test:e2e` | **19 passed**, Chromium 153, approximately 4.2 minutes |
...
The static export is about 2.83 MiB uncompressed before ZIP packaging. This is asset size, not a claimed frame-rate or latency result.
