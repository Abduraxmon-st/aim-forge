...
- Shared, short page/card entrances, dropdown/calendar reveals, checkbox/radio feedback and button/card interactions use CSS motion. The overview header has gently floating targets, plus signs and dots. Saved and system reduced-motion preferences suppress animation; gameplay receives no page transition.
